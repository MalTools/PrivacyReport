...
def prompt_input(functionality: str, statements: str, stack_trace: str, data_type: str, example: str) -> str:
    return f'Here is the app: : "{functionality}"\n' \
           ...
           f'I\'ll give you an example of chain-of-thought reasoning:\n{example}'
...
if __name__ == '__main__':
    ...
    start = time.time()
    append_messages(messages, ROLE_USER, prompt_input(items[0], items[1], items[2], items[3], examples[1]))
    resp = chat(messages)
    end = time.time()
